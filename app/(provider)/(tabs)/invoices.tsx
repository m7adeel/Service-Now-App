...
import { Receipt, Plus, Send, DollarSign } from 'lucide-react-native';
  ...
  return (
    <SafeAreaView className="flex-1 bg-white">
      <View className="px-6 py-4 flex-row items-center justify-between">
        ...
        <TouchableOpacity className="bg-primary-500 rounded-lg p-2">
      ...
      <View className="flex-1 justify-center items-center px-6">
        ...
        <TouchableOpacity className="bg-primary-500 rounded-lg px-6 py-3 mt-6">
